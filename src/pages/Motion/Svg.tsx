...
const Svg = () => {
  ...
  return(
    ...
    <motion.line x1="255" y1="10.0002" x2="255" y2="492" stroke="url(#paint2_linear_3_38)" strokeWidth="10" variants={pathVariants}/>
    <motion.line x1="82.5353" y1="74.4647" x2="426.189" y2="418.119" stroke="url(#paint3_linear_3_38)" strokeWidth="10" variants={pathVariants}/>
    <motion.line x1="423.896" y1="80.5357" x2="79.5354" y2="424.897" stroke="url(#paint4_linear_3_38)" strokeWidth="10" variants={pathVariants}/>
    <motion.path d="M250.5 51.0001C164 -8.99987 199 108.5 109.5 108.5C1.49972 118.5 109.5 159 50.4998 249.5C-8.50026 340 91.4998 298.5 109.5 389.5C127.5 480.5 153.5 402 250.5 449.5C347.5 497 292.5 408 391 389.5C489.5 371 391 328 449.5 249.5C508 171 405.5 199.5 391 108.5C376.5 17.5001 313.873 94.9584 250.5 51.0001Z" stroke="url(#paint5_linear_3_38)" strokeWidth="10" variants={pathVariants}/>
    <circle cx="134" cy="196" r="20" stroke="url(#paint6_linear_3_38)" strokeWidth="10"/>
    <circle cx="207" cy="140" r="20" stroke="url(#paint7_linear_3_38)" strokeWidth="10"/>
    <circle cx="299" cy="140" r="20" stroke="url(#paint8_linear_3_38)" strokeWidth="10"/>
    <circle cx="378" cy="196" r="20" stroke="url(#paint9_linear_3_38)" strokeWidth="10"/>
    <circle cx="378" cy="297" r="20" stroke="url(#paint10_linear_3_38)" strokeWidth="10"/>
    <circle cx="207" cy="360" r="20" stroke="url(#paint11_linear_3_38)" strokeWidth="10"/>
    <circle cx="134" cy="297" r="20" stroke="url(#paint12_linear_3_38)" strokeWidth="10"/>
    <circle cx="299" cy="360" r="20" stroke="url(#paint13_linear_3_38)" strokeWidth="10"/>
    <defs>
    <linearGradient id="paint0_linear_3_38" x1="250" y1="0.000198364" x2="250" y2="500" gradientUnits="userSpaceOnUse">
    <stop stopColor="#FFD600"/>
    <stop offset="0.171875" stopColor="#FFB800"/>
    <stop offset="0.854167" stopColor="#FF7A00"/>
